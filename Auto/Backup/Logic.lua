--[[
		...
		{"hook_id": "lib/units/enemies/cop/logics/coplogicintimidated","script_path": "Auto/Logic.lua"		}
]]
--[[
...
--[[
if CopLogicAttack then CopLogicAttack.on_intimidated = CopLogicIdle.on_intimidated end
if CopLogicArrest then CopLogicArrest.on_intimidated = CopLogicIdle.on_intimidated end
if CopLogicSniper then CopLogicSniper.on_intimidated = CopLogicIdle.on_intimidated end
]]