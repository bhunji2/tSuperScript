if not _G.tSuperScriptSet["InGameMap"] then return end
...
function HUDManager:update(t, dt, ...)
	--HUDMiniMap:set_enabled(_G.tSuperScriptSet["InGameMap"])
...
function HUDMiniMap:init(parent)
	...
	self._zoom = _G.tSuperScriptSet["InGameMapZoom"]
	...
	self._rotate_with_player = _G.tSuperScriptSet["InGameMapRotate"]
